...
TEST(RequiredCheckEqualFailureContainsCorrectDetails)
{
    ...
    RecordingReporter reporter;
    {
        ...
        try
        {
            line = __LINE__; REQUIRE_EQUAL(1, 123);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckEqualDoesNotHaveSideEffectsWhenPassing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_EQUAL(1, FunctionWithSideEffects());
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckEqualDoesNotHaveSideEffectsWhenFailing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_EQUAL(2, FunctionWithSideEffects());
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckCloseSucceedsOnEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_CLOSE(1.0f, 1.001f, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckCloseFailureContainsCorrectDetails)
{
    ...
    RecordingReporter reporter;
    {
        ...
        try
        {
            line = __LINE__; REQUIRE_CLOSE(1.0f, 1.1f, 0.01f);
            CHECK(false);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
...
TEST(RequiredCheckCloseDoesNotHaveSideEffectsWhenPassing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_CLOSE (1, FunctionWithSideEffects(), 0.1f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckCloseDoesNotHaveSideEffectsWhenFailing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_CLOSE(2, FunctionWithSideEffects(), 0.1f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckArrayCloseSucceedsOnEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY_CLOSE (data, data, 4, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArrayCloseFailsOnNotEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY_CLOSE (data1, data2, 4, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArrayCloseFailureContainsCorrectDetails)
{
    ...
    RecordingReporter reporter;
    {
        ...
        try
        {
            line = __LINE__; REQUIRE_ARRAY_CLOSE (data1, data2, 4, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckArrayEqualSuceedsOnEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY_EQUAL (data, data, 4);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArrayEqualFailsOnNotEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY_EQUAL (data1, data2, 4);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArrayEqualFailureContainsCorrectInfo)
{
    ...
    RecordingReporter reporter;
    {
        ...
        try
        {
            line = __LINE__; REQUIRE_ARRAY_EQUAL (data1, data2, 4);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckArrayCloseDoesNotHaveSideEffectsWhenPassing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_ARRAY_CLOSE (data, FunctionWithSideEffects2(), 4, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckArray2DCloseSucceedsOnEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY2D_CLOSE(data, data, 2, 2, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArray2DCloseFailsOnNotEqual)
{
    ...
    bool exception = false;
    {
        ...
        try
        {
            REQUIRE_ARRAY2D_CLOSE (data1, data2, 2, 2, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
            exception = true;
...
TEST(RequiredCheckArray2DCloseFailureContainsCorrectDetails)
{
    ...
    RecordingReporter reporter;
    {
        ...
        try
        {
            line = __LINE__; REQUIRE_ARRAY2D_CLOSE (data1, data2, 2, 2, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
...
TEST(RequiredCheckArray2DCloseDoesNotHaveSideEffectsWhenPassing)
{
    g_sideEffect = 0;
    {
        ...
        try
        {
            REQUIRE_ARRAY2D_CLOSE (data, FunctionWithSideEffects3(), 2, 2, 0.01f);
        }
        catch (const UnitTest::RequiredCheckFailedException&)
        {
        }
